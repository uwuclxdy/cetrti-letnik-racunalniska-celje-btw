// Rešitvi dodaj projekt Datum z razredom Datum. Razred Datum naj ima vse, kar ima razred
// Datum_v5, razen izpisovanja števila datumov v konstruktorjih in destruktorju.
// Poleg tega naj ima še naslednje objektne metode:
// - JeLetoPrestopno()
// - PovecajDatum(), PomanjsajDatum()
// - PovecajDatum(int dni), PomanjsajDatum(int dni)
// - DanVTednu (Zellerjev algoritem)
// - Izpisi(oblika): d.m.llll (privzeto), d.mmm.llll, dd.mm.ll
// - Statično verzijo Izpisi(datum, oblika)
